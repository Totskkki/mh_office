...
if (isset($_POST['labid'])) {
    $id = $_POST['labid'];
    $queryUsers = "SELECT * FROM tbl_laboratory    
     WHERE patient_id = :id";
...
<body>
                                                ...
                                                <div class="col-xl-4 col-sm-6 col-12">
                                                    <div class="card mb-4 card-outline rounded-0 shadow">
                                                        <div class="card-header  rounded-1 shadow ">
                                                            <h5 class="card-title">Laboratory <span><a href="#" type="button" id="Laboratory" class="btn btn-info float-end">
                                                                        <i class="icon-plus"></i>
                                                                ...
                                                                <p>
                                                                    <?php foreach ($labqueryData as $lab) { ?>
                                                                        <li>
                                                                            ...
                                                                            <button class="btn btn-info btn-sm float-end" data-bs-toggle="modal" data-bs-target="#Viewlabresult" data-record-id="<?php echo $lab['labid']; ?>">
                                                                                <i class="icon-eye"></i>
                                                                            </button>
                                                                        </li>
                                            ...
                                            <form method="POST" id="familymember" style="display: none;" novalidate>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-3 col-sm-4 col-12">
                                                        <div class="mb-3">
                                                            <label class="form-label" for="patient_name">Name: <span class="text-danger">*</span></label>
                                                            <input type="text" class="form-control " name="Name" id="Name"
                                                                pattern="^[A-Za-z\s]{2,}$"
                                                                title="First name should be at least 2 characters and contain only letters." required />
                                                                ...
                                                                <div class="modal-content">
                                                                    <div class="modal-body p-5">
                                                                        <div class="mb-3 row">
                                                                            ...
                                                                            <div class="col-sm-8">
                                                                                <select id="service" name="service" class="form-select" required>
                                                                                    <option value=" Count">-Select-</option>
                                                                        ...
                                                                        <div class="mb-3 row">
                                                                            ...
                                                                            <div class="col-sm-8">
                                                                                <textarea name="testresults" id="testresults" cols="30" rows="3" class="form-control" style="resize:none;"></textarea>
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="mb-3 row">
                                                                            ...
                                                                            <div class="col-sm-8">
                                                                            <img id="labImage" src="" alt="Lab Test Image" class="img-fluid" style="max-width:100%; max-height:400px;">
                                        ...
                                        <div class="modal-dialog modal-lg" role="document">
                                            <div class="modal-content">
                                                <div class="modal-body p-5">
                                                    ...
                                                    <div class="mb-3 row">
                                                    <label for="text" class="col-sm-3 col-form-label text-center">Image</label>
                                                    <div class="col-sm-8">
                                                        <input type="file"  id="image" cols="30" rows="3" class="form-control" style="resize:none;"></input>
                                                    </div>
                                                </div>
    ...
    <script>
        $('#Viewlabresult').on('show.bs.modal', function(event) {
            ...
            $.ajax({
                type: 'POST',
                url: 'view_patient.php', // Ensure this URL is correct
                data: {

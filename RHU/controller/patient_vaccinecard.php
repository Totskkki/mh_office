...
if (isset($_GET['id'])) {
    ...
    // LEFT JOIN tbl_animal_bite_care ab on ab.patient_id = av.patient_id
    // WHERE av.patient_id = (SELECT patient_id FROM tbl_animal_bite_vaccination WHERE animal_bite_vacID = :vaccination_id) 
    // AND ab.bite_status = 'ongoing'

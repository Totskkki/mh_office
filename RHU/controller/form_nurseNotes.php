...
if (isset($_GET['id'])) {
    ...
    if ($record) {
        ...
        AND iv.nureNotes != '' 
        AND (iv.doctorNotes IS NULL OR iv.doctorNotes = '')
        GROUP BY iv.date, iv.time, iv.nureNotes";
                    ...
                    <table border="1">
                        ...
                        <?php foreach ($DoctorsData as $DoctorsDatas): ?>
                            <tr>
                                ...
                                <td><?php echo htmlspecialchars($DoctorsDatas['nureNotes']); ?></td>

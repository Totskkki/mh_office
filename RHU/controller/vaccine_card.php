...
if (isset($_GET['id'])) {
    ...
    $stmt->bindParam(':animal_biteID', $recordId, PDO::PARAM_INT);
    $stmt->execute();
    ...
    if ($records) {
        ...
        // Fetch the latest remarks for the patient's vaccination
        ...
        $pdf = new TCPDF('P', PDF_UNIT, array(120, 170), true, 'UTF-8', false);
        ...
        $typeBiteData = isset($records[0]['Type_bite']) ? json_decode($records[0]['Type_bite'], true) : [];
        ...
        $pdf->Output('Animal_Bite_Vaccine_Form.pdf', 'I');
    } else {

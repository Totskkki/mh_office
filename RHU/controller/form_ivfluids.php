...
if (isset($_GET['id'])) {
    ...
    if ($record) {
        ...
        $IVFluidsQuery = "SELECT iv.*,b.*,b.date
        ...
        $stmtVitals = $con->prepare($IVFluidsQuery);
        $stmtVitals->bindParam(':patientId', $record['patientID'], PDO::PARAM_INT); 
        $stmtVitals->execute();

       
        $IVFluidsData = $stmtVitals->fetchAll(PDO::FETCH_ASSOC);
    ...
    <div class="page-wrapper">
        <div class="app-container">
            <div class="app-body">
                ...
                <h4 class="text-center mb-3 "><b>IV FLUIDS SHEET</b></h4>
                    ...
                    <table border="1">
                        ...
                        <?php foreach ($IVFluidsData as $IVFluids): ?>
                            <tr>
                                <td><?php echo htmlspecialchars($IVFluids['date']); ?></td>
                                
                                <td><?php echo htmlspecialchars(!empty($IVFluids['timeStarted']) ? date('h:i A', strtotime($IVFluids['timeStarted'])) : '') ;?></td>
                                <td><?php echo htmlspecialchars(!empty($IVFluids['timeconsumed']) ? date('h:i A', strtotime($IVFluids['timeconsumed'])) : '') ;?></td>
                                <td><?php echo htmlspecialchars($IVFluids['bottleno']); ?></td>
                                <td><?php echo htmlspecialchars($IVFluids['solution']); ?></td>
                                <td><?php echo htmlspecialchars($IVFluids['signature_remarks']); ?></td>

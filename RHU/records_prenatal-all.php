                                        ...
                                        <div class="card mb-4">
                                            <div class="card-body">
                                                <div class="mb-2 d-flex align-items-end justify-content-between">
                                                    ...
                                                    <a href="records_prenatal.php" class="btn btn-primary float-end">
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-striped table-bordered align-middle m-0">
                                                        ...
                                                        <tbody>
                                                        <?php
                                                            $query = "SELECT * FROM tbl_prenatal  
                                                           
                                                            WHERE patient_id = :patientID order by prenatalID  asc ";
                                                        ...
                                                        ?>
                                                                <tr>
                                                                  ...
                                                                  <td>  <?php echo htmlspecialchars(date('M, d, Y', strtotime($record['date']))); ?> </td>
                                                                    ...
                                                                    <td><?php echo htmlspecialchars($record['radiologist']); ?></td>
                                                                    <td class="text-center">
                                                                        <a href="controller/view_prenatal_form.php?id=<?php echo htmlspecialchars($record['prenatalID']); ?>" class="btn btn-outline-info btn-sm" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-custom-class="custom-tooltip-primary" data-bs-title="View Details" >

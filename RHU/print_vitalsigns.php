...
<body>
    ...
    <div class="page-wrapper">
        <div class="app-container">
            <div class="app-body">
            <button class="btn btn-secondary" onclick="printContent('print')" style="float: right;">Print Content</button>
                <button onclick="window.history.back()" class="btn btn-primary"><i class="icon-chevron-left"></i>Back</button>
               
                <div class="container" id="print">

                <h4 class="text-center mb-3 "><b>VITAL SIGNS MONITORING SHEET</b></h4>
                    <div class="row">
                    ...
                    <table border="1">
                        ...
                        <?php foreach ($vitalSignsData as $vitalSign): ?>
                            <tr>
                                <td><?php echo htmlspecialchars($vitalSign['date_shift']); ?></td>
                                
                                <td><?php echo htmlspecialchars(!empty($vitalSign['time']) ? date('h:i A', strtotime($vitalSign['time'])) : '') ;?></td>
                                <td><?php echo htmlspecialchars($vitalSign['bp']); ?></td>
                                <td><?php echo htmlspecialchars($vitalSign['cr']); ?></td>
                                <td><?php echo htmlspecialchars($vitalSign['rr']); ?></td>
                                <td><?php echo htmlspecialchars($vitalSign['temp']); ?></td>
                                <td><?php echo htmlspecialchars($vitalSign['fht']); ?></td>
                                <td><?php echo htmlspecialchars($vitalSign['duration']); ?></td>
                                <td><?php echo htmlspecialchars($vitalSign['frequency']); ?></td>
                                <td><?php echo htmlspecialchars($vitalSign['intensity']); ?></td>
                                <td><?php echo htmlspecialchars($vitalSign['midwifenurse']); ?></td>
                            </tr>
                        <?php endforeach; ?>

                    ...
                    <div class="container-fluid">
                        ...
                        if (isset($_GET['id'])) {
                            ...
                            $query = "SELECT a.*, pat.*, fam.*,
                                      ...
                                      WHERE a.patient_id = :patientID ORDER BY a.patient_id desc";
                                        ...
                                        <div class="card mb-4">
                                            <div class="card-body">
                                                <div class="mb-2 d-flex align-items-end justify-content-between">
                                                    ...
                                                    <a href="checkup_record.php" class="btn btn-primary float-end">
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-striped table-bordered align-middle m-0">
                                                        ...
                                                        <?php
                                                            ...
                                                            WHERE patient_id = :patientID order by checkupID   DESC ";
                                                        ...
                                                        ?>
                                                                <tr>
                                                                  ...
                                                                  <td>  <?php echo htmlspecialchars(date('M, d, Y', strtotime($record['admitted']))); ?> -  <?php echo htmlspecialchars(date('h:i A', strtotime($record['admitted']))); ?></td>
                                                                  
                                                                   
                                                                    <td><?php echo htmlspecialchars($record['doctor_order']); ?></td>
                                                                    <td class="text-center">
                                                                        <a href="controller/viewcheckup_form.php?id=<?php echo htmlspecialchars($record['checkupID']); ?>" class="btn btn-outline-info btn-sm" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-custom-class="custom-tooltip-primary" data-bs-title="View Details" >

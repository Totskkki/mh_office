...
if (isset($_POST['backup'])) {
  backupDatabaseTables('localhost', 'u926430213_totski', 'Joven261993@', 'u926430213_mh_office');
}
...
function restoreDatabase($filePath) {
  $dbHost = 'localhost';
  $dbUsername = 'u926430213_totski';
  $dbPassword = 'Joven261993@';
  $dbName = 'u926430213_mh_office';

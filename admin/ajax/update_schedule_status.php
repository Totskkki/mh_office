<?php
    ...
    if (isset($input['doc_scheduleID']) && isset($input['is_available'])) {
        $docScheduleID = $input['doc_scheduleID'];
        $newStatus = $input['is_available'];
    
        try {
            // Prepare and execute the update query
            $query = "UPDATE tbl_doctor_schedule SET is_available = :is_available WHERE doc_scheduleID = :doc_scheduleID";
